				  ...
				  <%-- <c:forEach items="${commodityList}" var="commodity">
					...
					<c:forEach items="${commoditypictureList}" var="commoditypicture">
						 <div class="col-md-4 fashion-grid" style="margin-top: 2em;margin-bottom: 2em;">
							 ...
							 <div class="fashion-view"><span></span>
									<div class="clearfix"></div>
									 <h4><a href="toSinglejsp.do?commodityId=${commoditypicture.commodityId}&commodityPrice=${commoditypicture.commodityPrice}&commodityName=${commoditypicture.commodityName}&cpURL=${commoditypicture.cpURL}">Quick View</a></h4>
							 </div>
						 </div>
					 </c:forEach>
					 <div class="clearfix"></div>
<%-- 					 <div style="padding-bottom: 60px;">
		 ...
		 <div class="col-md-3 side-bar">
			  ...
			  <div class="sales">
				 ...
				 <div class="pricing">
					 <h4>按价格搜索</h4>
					 <form action="manGategories.do?commodityisman=男&currentPage=1&gategoriesName=${gategoriesN}"  method="post">
